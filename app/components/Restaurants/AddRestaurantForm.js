...
export default function AddRestaurantForm(props) {
    ...
    const [restaurantName, setRestauranteName] = useState("");
    ...
    return (
        <ScrollView>
            ...
            <FormAdd 
                     setRestaurantName={setRestauranteName}
...
function UploadImagen(props) {
    ...
    const imageSelect = async () => {
        ...
        if(resultPermissionCamera === "denied") {
            toastRef.currnet.show("Es necesario aceptar los permisos de la galeria",
            3000
            )
        } else {
    ...
    const removeImage = image => {
        ...
        Alert.alert(
            "Eliminar Imagen",
            "Estas seguro de que quieres elimianar la imagen?",
            [
                {
                    text: "Cancel",
                    style: "cancel"
