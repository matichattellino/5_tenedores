...
export default function InfoUser(props) {
    ...
    const changeAvatar = async () => {
        ...
        if(resultPermissionCamera === "denied") {
            ...
            if(result.cancelled) {
                toastRef.current.show("Has cerrado la geleria sin seleccinoar imagenes")
            } else {
    ...
    const updatePhotoUrl = uid => {
        firebase
            ...
            .then(async result => {
                ...
                toastRef.current.show("Error al recuperar el avatar del seguidor")
            })
    }
